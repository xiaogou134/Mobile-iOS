...
//        [self removeFromSuperview];
        UIBezierPath *path = [UIBezierPath bezierPathWithArcCenter:CGPointMake(self.frame.size.width/2, self.frame.size.width/2) radius:self.frame.size.width/2 - (_lineWidth+_blankWidth) * (i+1)   startAngle:-M_PI/2  endAngle:M_PI * 2 * [context[i][@"score"]  floatValue] - 0.07 - M_PI/2 clockwise:YES];
